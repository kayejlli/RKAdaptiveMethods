...
Fortran/rk1412Feagin.f90: Fortran/%Feagin.f90: Python/%.py Convert0.py
	python3 Convert0.py Python/$*.py 35 12 $*Feagin 
Fortran/rk108Feagin.f90: Fortran/%Feagin.f90: Python/%.py Convert0.py
	python3 Convert0.py Python/$*.py 17 8 $*Feagin
Fortran/rk1210Feagin.f90: Fortran/%Feagin.f90: Python/%.py Convert0.py
	python3 Convert0.py Python/$*.py 25 10 $*Feagin
Fortran/rk87EnrightVerner.f90: Fortran/%.f90: Python/%_13.py Convert0.py
	python3 Convert0.py Python/$*_13.py 13 7 $* 
Fortran/rk65Dormand.f90: Fortran/%.f90: Python/%8.py Convert0.py
	python3 Convert0.py Python/$*8.py 8 5 $* 
Fortran/rk1211Peter.f90: Fortran/%Peter.f90: Python/%_31.py Convert0.py 
	python3 Convert0.py Python/$*_31.py 31 11 $*Peter
Fortran/rk109Legendre.f90: Fortran/%Legendre.f90: Python/%_21.py Convert0.py
	python3 Convert0.py Python/$*_21.py 21 9 $*Legendre
Fortran/rk87Dormand.f90: Fortran/%.f90: Python/RK8713M.py Convert0.py
	python3 Convert0.py Python/RK8713M.py 13 7 $*
Fortran/rk54Dormand.f90: Fortran/%.f90: Python/%7.py Convert0.py
	python3 Convert0.py Python/$*7.py 7 5 $*
Fortran/rk54Sharp.f90: Fortran/%.f90: Python/%7.py Convert0.py
	python3 Convert0.py Python/$*7.py 7 5 $*
